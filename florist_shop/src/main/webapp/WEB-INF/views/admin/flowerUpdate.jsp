			...
			<TD width="100%">
				...
				<legend>修改商品</legend>
					 ...
					 <tr>
					    ...
					    <td width="41%"> 
					    <input name="flName"  value="爱的火热" class="text" style="width:250px" type="text" size="40" />
				        <span class="red"> *</span></td>
					    <td align="right" width="19%">商品价格：</td>
					    <td width="27%">
					    <input name="flPrice"  value="12" class="text" style="width:250px" type="text" size="40" />
					    </td>
					    </tr>
					  <tr>
					   ...
					   <input type="file" name="nfile"     />
				        <span class="red"> *</span></td>
					    <td align="right" width="19%">缩略图:</td>
					    <td width="27%">
					   ...
					   <tr>
					    <td nowrap align="right" height="120px">介绍:</td>
